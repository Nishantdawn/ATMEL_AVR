...
#define LCD_D4	5	//define MCU pin connected to LCD D4
...
void lcd_init(uint8_t);			//Initializes LCD
void lcd_clear(void);				//Clears LCD
void lcd_gotoxy(uint8_t, uint8_t);	//Cursor to X Y position
void lcd_putchar(uint8_t);		//forms data ready to send to LCD
void lcd_puts(uint8_t*);	//Outputs char array to LCD
void lcd_putsf(uint8_t*);	//Outputs string to LCD
